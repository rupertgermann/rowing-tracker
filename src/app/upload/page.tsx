...
export default function UploadPage() {
  const { addSessions, getSessions } = useRowingStore();
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground text-lg">
            Upload your CSV export to visualize your rowing performance
          </p>
        </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-semibold text-foreground">
                    {uploadState === 'dragging' ? 'Drop your CSV file here' : 'Drag and drop your CSV file here'}
                  </h3>
                ...
                <p className="text-sm text-muted-foreground">
                  Only SmartRow CSV files are supported
                </p>
                <input
                  id="file-input"
                  type="file"
          ...
          <Card>
            <CardContent className="p-12 text-center">
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-semibold text-foreground">
                    {uploadState === 'validating' ? 'Validating file format...' : 'Processing your data...'}
                  </h3>
                  <p className="text-muted-foreground">
                    {uploadState === 'validating' 
                      ? 'Checking if this is a valid SmartRow CSV file'
                      : 'Parsing your rowing sessions and calculating statistics'
                    }
                  </p>
                </div>
                {selectedFile && (
            ...
            <CardContent className="p-12 text-center">
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-lg">
                    Your rowing data has been imported successfully
                  </p>
                </div>
              ...
              <div className="grid gap-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Drag and drop the exported CSV file above or click to browse
                    </p>
                  </div>
                </div>
              </div>
